...
var availProds = "";
var customerPrice = 0;
var supOptions = ["View Product Sales by Department", "Create New Department"];
var prodToAdd = "";
...
var letsgo = function() {
  ...
  ]).then(function(supChose){
    var supChoice = supChose.supChoice;
    if (supChoice === "View Product Sales by Department") {
      query = "SELECT ";
      connection.query(query, function(err, dbContent) {
        if (err) {
